...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We accept all major credit cards (Visa, Mastercard, American Express, Discover) and other payment methods through our secure payment processor, Paddle.',
    },
    {
