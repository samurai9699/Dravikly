                ...
                >
                  ...
                  <div className="mb-6 pb-6 border-b border-slate-700">
                    <div className="flex items-center justify-center space-x-2 text-lg">
                      ...
                      <span className="font-semibold">
                        {typeof tier.analyses === 'number' ? `${tier.analyses}` : tier.analyses}
                      </span>
                      {tier.analysisText && (
                        <span className="text-slate-400">{tier.analysisText}</span>
                      )}
                    </div>
                  </div>
        ...
        <section className="max-w-6xl mx-auto mt-32">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'Cost', dravikly: '$0-299/mo', agency: '$5k-20k', manual: 'Your time', icon: '💰' },
                    ...
                    { feature: 'Unlimited Analyses', dravikly: 'Yes (Enterprise)', agency: 'No', manual: 'Yes', icon: '♾️' },
                  ].map((row, index) => (
          ...
          <div className="mt-8 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-400/30 rounded-xl p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">ROI or You Don’t Pay</h3>
                <p className="text-slate-300">
                  If we can’t uncover clear opportunities that would realistically boost your conversions,
                  you get your first month refunded. Simple, fast, and drama-free.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-4xl mx-auto mt-32 text-center">
          <div className="bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 border border-cyan-400/30 rounded-2xl p-12">
            ...
            <p className="text-slate-400 mt-4 text-sm">
              No credit card required • 5 free analyses • Upgrade anytime
            </p>
          </div>
        </section>
      </main>

      <footer className="relative z-10 mt-32 border-t border-slate-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <circle cx="20" cy="20" r="18" stroke="url(#footer-logo-gradient)" strokeWidth="2" fill="none" opacity="0.3" />
                  <path d="M 12 20 Q 16 12, 20 20 T 28 20" stroke="url(#footer-logo-gradient)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
                  <circle cx="12" cy="20" r="2.5" fill="url(#footer-logo-gradient)" />
                  <circle cx="20" cy="20" r="2.5" fill="url(#footer-logo-gradient)" />
                  <circle cx="28" cy="20" r="2.5" fill="url(#footer-logo-gradient)" />
                  <path d="M 20 28 L 20 16 M 16 20 L 20 16 L 24 20" stroke="url(#footer-logo-gradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.8" />
                </svg>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-4">
                AI-powered conversion optimization that finds the invisible friction killing your sales.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/guide" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">
                    CRO Guide
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-8 border-t border-slate-800">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-slate-400 text-sm">
                &copy; 2025 Dravikly. All rights reserved. Built for conversion-obsessed founders.
              </p>
